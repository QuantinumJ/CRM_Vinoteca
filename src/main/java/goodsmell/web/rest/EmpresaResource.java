...
import goodsmell.domain.Empresa;
import goodsmell.repository.EmpresaRepository;
...
/**
 * REST controller for managing {@link goodsmell.domain.Empresa}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmpresaResource {
    ...
    public ResponseEntity<Empresa> partialUpdateEmpresa(
        ...
        Optional<Empresa> result = empresaRepository
            ...
            .map(existingEmpresa -> {
                if (empresa.getNombreSocial() != null) {
                    existingEmpresa.setNombreSocial(empresa.getNombreSocial());
                }
