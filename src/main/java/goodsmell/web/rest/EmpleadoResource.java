...
import goodsmell.domain.Empleado;
import goodsmell.repository.EmpleadoRepository;
...
/**
 * REST controller for managing {@link goodsmell.domain.Empleado}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Empleado> result = empleadoRepository
            ...
            .map(existingEmpleado -> {
                ...
                if (empleado.getFechaAlta() != null) {
                    existingEmpleado.setFechaAlta(empleado.getFechaAlta());
                }
