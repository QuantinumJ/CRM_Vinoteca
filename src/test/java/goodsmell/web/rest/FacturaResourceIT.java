...
import goodsmell.domain.Factura;
import goodsmell.repository.FacturaRepository;
...
class FacturaResourceIT {
    ...
    public static Factura createEntity(EntityManager em) {
        Factura factura = new Factura().numero(DEFAULT_NUMERO).fecha(DEFAULT_FECHA);
        return factura;
    }
    ...
    public static Factura createUpdatedEntity(EntityManager em) {
        Factura factura = new Factura().numero(UPDATED_NUMERO).fecha(UPDATED_FECHA);
        return factura;
    }
    ...
    void putNewFactura() throws Exception {
        ...
        updatedFactura.numero(UPDATED_NUMERO).fecha(UPDATED_FECHA);
    ...
    void fullUpdateFacturaWithPatch() throws Exception {
        ...
        partialUpdatedFactura.numero(UPDATED_NUMERO).fecha(UPDATED_FECHA);
